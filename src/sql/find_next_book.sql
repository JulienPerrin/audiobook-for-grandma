SELECT IDENTIFIER, TITLE, CREATOR, DOWNLOADS, PUBLISHER, VOLUME, ENCODING, DOWNLOADED FROM (
    SELECT IDENTIFIER, TITLE, CREATOR, DOWNLOADS, PUBLISHER, VOLUME, ENCODING, DOWNLOADED,
