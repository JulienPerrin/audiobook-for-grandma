SELECT IDENTIFIER, TITLE, CREATOR, DOWNLOADS, PUBLISHER, VOLUME, ENCODING, DOWNLOADED, HREF FROM (
    SELECT IDENTIFIER, TITLE, CREATOR, DOWNLOADS, PUBLISHER, VOLUME, ENCODING, DOWNLOADED, HREF,
